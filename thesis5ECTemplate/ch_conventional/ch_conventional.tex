...
また，観測信号に短時間フーリエ変換（short-time Fourier transformation: STFT）を行うことで，スペクトログラムを描画する．Fig. \ref{fig:obsspect}は，Fig. \ref{fig:obssig}にSTFTを行ったものである．60秒から360秒に横一直線に確認できる成分が振動成分，約3Hzに確認できる最も強い成分が呼吸成分，振動成分に隠れるように心拍成分が表れている．このように時間信号をスペクトログラム
に描画することで，各成分が確認できるようになる．
